<template>
  <div class="collaborative-manage-page-container">
    <div class="manage-page-container">
      <!-- <input type="text" v-model="newDocumentTitle" /> -->
      <!-- <button @click="getNewDocumentToken">点击一下，测试得到documentToken</button> -->
      <!-- <button @click="ifShowTheCreateNewDocWindow = true">点击一下，打开新建文档页面</button> -->
      ...
      <div class="operation-container">
        ...
        ></div>
        <img
          src="@/assets/common/Team meeting_Two Color.svg"
          style="width: 90%"
        />
      </div>
      ...
      <div class="table-container">
        <el-table :data="document_list" style="width: 100%" border height="550">
          <!-- 
          这里按照黄学长的建议，取消文档id的展示，
          并把原先分配给文档id的宽度 加一些在
          文档标题（原来是170）、文档创建者（原来是120）、两个时间（原来是160）上
         -->
          <!-- <el-table-column
            prop="document_id"
            label="文档id"
          ...
          <el-table-column label="文档最后更新时间" width="170">
            <template slot-scope="scope">
              <i class="el-icon-time"></i>
...
export default {
  ...
  methods: {
    ...
    async getCurrentDocumentList() {
      ...
      let project_id = JSON.parse(localStorage.getItem("project")).project_id;
        ...
        .then((res) => {
          ...
          switch (res.data.result) {
            case 1: {
              ...
              this.$router.push("/projectdetail/collaborative-editor");
